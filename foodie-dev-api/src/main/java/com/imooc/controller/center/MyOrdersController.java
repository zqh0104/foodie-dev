...
//        }
        ...
        Page<MyOrdersVO> myOrdersVOPage = myOrdersService.queryMyOrders(userId, orderStatus, page, pageSize);

        return IMOOCJSONResult.ok(myOrdersVOPage);
    }
...
//        }
        ...
        Page<OrderStatus> orderStatusPage = myOrdersService.getOrdersTrend(userId,
                page,
                pageSize);

        return IMOOCJSONResult.ok(orderStatusPage);
    }
